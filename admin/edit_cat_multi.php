...
if($_GET['id']) {
    ...
    $sql = "SELECT * FROM category_multi WHERE id = {$id}";
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <fieldset>
    <legend>Uredi naziv ispita</legend>
 
    <form action="php_action/update_cat_multi.php" method="post">
        <table cellspacing="0" cellpadding="0">
            <tr>
                <th>Ime ispita : </th>
                <td><input type="text" name="cat_name" placeholder="Naziv ispita" value="<?php echo $data['cat_name'] ?>" /></td>
            </tr>     
        ...
        <input type="hidden" name="id" value="<?php echo $data['id']?>" />
                ...
                <a href="kategorije_multi.php"><button class='btn btn-warning' type="button">Back</button></a>
    </form>
